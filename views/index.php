<main>
    ...
    <div class="position-relative overflow-hidden text-center bg-light custom-banner d-flex h-100">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4 text-center padding-box">
                <div class="my-3 py-3 highlighted-box">
            ...
            <div class="col-sm-4 text-center padding-box">
                <div class="my-3 py-3 highlighted-box">
                    <i class="fas fa-bullhorn fa-2x fa-logo"></i>
                <h2 class="">Bekijk mededelingen</h2>
                <p class="lead">Een online overzicht van belangrijke mededelingen</p>
                </div>
            </div>
            <div class="col-sm-4 text-center padding-box">
                <div class="my-3 py-3 highlighted-box">
